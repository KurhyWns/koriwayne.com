...
- **Container Registry**: [Docker Registry](../docker-registry/index.md) (local deployment)
...
3. Deploy [Docker Registry](../docker-registry/index.md) for container storage
4. Configure basic RBAC and network policies

### Phase 3: CI/CD
1. Deploy Jenkins or Tekton
2. Set up Gitea for Git hosting
3. Configure automated builds and push to Docker Registry
